...
policy_net = DQN(n_observations, n_actions, layers=5, width=64).to(device)
target_net = DQN(n_observations, n_actions, layers=5, width=64).to(device)
